...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 20, 2020 at 02:36 PM
...
INSERT INTO `booking` (`bookingID`, `fk_userID`, `fk_dateID`, `humanCage`, `breakfast`, `wellness`, `priceSum`) VALUES
(1, 2, 1, 1, 1, 1, 0),
(2, 2, 2, 1, 0, 1, 0),
(3, 2, 3, 0, 0, 0, 0);
...
INSERT INTO `date` (`dateID`, `startDate`, `endDate`, `fk_roomID`) VALUES
(1, '2020-01-20', '2020-01-22', 1),
(2, '2020-01-21', '2020-01-23', 2),
(3, '2020-01-24', '2020-01-25', 4);
